...
<ol>
  ...
  <li> Choose the one that says "Lime's pink theme" </li>
  <li> Close the window and it should be working (if it doesnt js restart the launcher)</li>
</ol>
<p>
